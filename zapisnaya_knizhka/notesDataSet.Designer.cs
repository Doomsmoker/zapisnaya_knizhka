...
namespace zapisnaya_knizhka {
    ...
    public partial class notesDataSet : global::System.Data.DataSet {
        ...
        public partial class Таблица1DataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public Таблица1Row AddТаблица1Row(string Фамилия, string Имя, string Отчество, string Контактные_данные, System.DateTime Дата_рождения, string Характер_знакомства, string Примечания) {
...
namespace zapisnaya_knizhka.notesDataSetTableAdapters {
    ...
    public partial class Таблица1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Таблица1` WHERE ((`Код` = ?) AND ((? = 1 AND `Фамилия` IS NULL) OR (`Фамилия` = ?)) AND ((? = 1 AND `Имя` IS NULL) OR (`Имя` = ?)) AND ((? = 1 AND `Отчество` IS NULL) OR (`Отчество` = ?)) AND ((? = 1 AND `Контактные данные` IS NULL) OR (`Контактные данные` = ?)) AND ((? = 1 AND `Дата рождения` IS NULL) OR (`Дата рождения` = ?)) AND ((? = 1 AND `Характер знакомства` IS NULL) OR (`Характер знакомства` = ?)) AND ((? = 1 AND `Примечания` IS NULL) OR (`Примечания` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Таблица1` (`Фамилия`, `Имя`, `Отчество`, `Контактные данные`, `Дата " +
                "рождения`, `Характер знакомства`, `Примечания`) VALUES (?, ?, ?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Таблица1` SET `Фамилия` = ?, `Имя` = ?, `Отчество` = ?, `Контактные данные` = ?, `Дата рождения` = ?, `Характер знакомства` = ?, `Примечания` = ? WHERE ((`Код` = ?) AND ((? = 1 AND `Фамилия` IS NULL) OR (`Фамилия` = ?)) AND ((? = 1 AND `Имя` IS NULL) OR (`Имя` = ?)) AND ((? = 1 AND `Отчество` IS NULL) OR (`Отчество` = ?)) AND ((? = 1 AND `Контактные данные` IS NULL) OR (`Контактные данные` = ?)) AND ((? = 1 AND `Дата рождения` IS NULL) OR (`Дата рождения` = ?)) AND ((? = 1 AND `Характер знакомства` IS NULL) OR (`Характер знакомства` = ?)) AND ((? = 1 AND `Примечания` IS NULL) OR (`Примечания` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Код, Фамилия, Имя, Отчество, [Контактные данные], [Дата рождения], [Характ" +
                "ер знакомства], Примечания FROM Таблица1";
        ...
        public virtual int Fill(notesDataSet.Таблица1DataTable dataTable) {
        ...
        public virtual notesDataSet.Таблица1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            notesDataSet.Таблица1DataTable dataTable = new notesDataSet.Таблица1DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(notesDataSet.Таблица1DataTable dataTable) {
        ...
        public virtual int Delete(int Original_Код, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Контактные_данные, global::System.Nullable<global::System.DateTime> Original_Дата_рождения, string Original_Характер_знакомства, string Original_Примечания) {
        ...
        public virtual int Insert(string Фамилия, string Имя, string Отчество, string Контактные_данные, global::System.Nullable<global::System.DateTime> Дата_рождения, string Характер_знакомства, string Примечания) {
            if ((Фамилия == null)) {
        ...
        public virtual int Update(string Фамилия, string Имя, string Отчество, string Контактные_данные, global::System.Nullable<global::System.DateTime> Дата_рождения, string Характер_знакомства, string Примечания, int Original_Код, string Original_Фамилия, string Original_Имя, string Original_Отчество, string Original_Контактные_данные, global::System.Nullable<global::System.DateTime> Original_Дата_рождения, string Original_Характер_знакомства, string Original_Примечания) {
            if ((Фамилия == null)) {
            ...
            if ((Original_Контактные_данные == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((string)(Original_Контактные_данные));
            }
            if ((Original_Дата_рождения.HasValue == true)) {
            ...
            if ((Original_Характер_знакомства == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((string)(Original_Характер_знакомства));
            }
            if ((Original_Примечания == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[21].Value = ((string)(Original_Примечания));
            }
